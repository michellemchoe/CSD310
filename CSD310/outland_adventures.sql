...
INSERT INTO trips(country_id, guide_id, trip_name, trip_date, client_count)
    VALUES((SELECT country_id FROM country WHERE country_name = 'Spain'), (SELECT guide_id FROM guides WHERE last_name = 'MacNell'), 'The Cares Trail', '2023-07-12', (SELECT COUNT(*) FROM clients_attending_trip WHERE trip_id = trip_id));
